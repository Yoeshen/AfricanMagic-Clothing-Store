...
namespace AfricanMagicSystem.Controllers
{
    ...
    public class CheckoutController : Controller
    {
        ...
        //
        // GET: /Checkout/AddressAndPaymentWithPoints
        public ActionResult AddressAndPaymentWithPoints()
        {
            ViewBag.CreditCardTypes = CreditCardTypes;
            var previousOrder = dB.Sales.FirstOrDefault(x => x.Username == User.Identity.Name);
        ...
        //
        // POST: /Checkout/AddressAndPaymentWithPoints
        [HttpPost]
        public async Task<ActionResult> AddressAndPaymentWithPoints(FormCollection values)
        {
            decimal deliveryFee = 0;
            decimal points = 0;
            int oldPoints = 0;
            ...
            try
            {
                ...
                //Process the order
                decimal amountTotal = deliveryFee;
                int amount = Convert.ToInt32(amountTotal);
                string orderId = sale.SaleId.ToString();
                sale = cart.CreateOrder(sale);
