...
namespace AfricanMagicSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> GuestLogin(GuestViewModel model, string returnUrl)
        {
            ...
            var result = await SignInHelper.PasswordSignIn(model.GuestEmail, model.GuestPassword, false, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await SignInHelper.PasswordSignIn(model.Email, model.Password, false, shouldLockout: false);
